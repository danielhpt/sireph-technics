package com.sireph.technics.models.victim.procedures;
...
public class ProcedureRCP extends _BaseModel<ProcedureRCP> {
    ...
    public ProcedureRCP(JSONObject json) {
        ...
        this.not_performed = boolFromJson(json, "not_performed", false);
    }
    ...
    public ProcedureRCP(boolean witnessed, DateTime SBV_DAE, DateTime SIV_SAV, String first_rhythm, Integer nr_shocks, DateTime recovery,
                        DateTime downtime, boolean mechanical_compressions, boolean not_performed) {
    ...
    public ArrayList<Flag> update(@NonNull ProcedureRCP updated) {
        ...
        if (this.not_performed != updated.not_performed) {
            this.not_performed = updated.not_performed;
            flags.add(Flag.UPDATED_RCP);
        }
        return flags;
    }
    ...
    public JSONObject toJson(@NonNull TypeOfJson type) throws JSONException {
        ...
        json.put("not_performed", this.not_performed);
    ...
    public void setNotPerformed(boolean not_performed) {
        this.not_performed = not_performed;
    }
}
