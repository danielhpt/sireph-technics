...
public class Symptom extends _BaseModel<Symptom> {
    ...
    private List<CompiledTrauma> compiledTraumas;
    ...
    public Symptom(JSONObject json) throws JSONException {
        ...
        compiledTraumas = CompiledTrauma.compileTraumas(traumas);
    }
    ...
    public ArrayList<Flag> update(@NonNull Symptom updated) {
        ...
        if (this.traumas.size() < updated.traumas.size()) {
            ...
            compiledTraumas = updated.compiledTraumas;
    ...
    public void addTrauma(Trauma trauma) {
        ...
        CompiledTrauma.addTrauma(compiledTraumas, trauma);
    }

    public void addTraumas(List<Trauma> traumas) {
        for (Trauma t : traumas) {
            addTrauma(t);
        }
    }

    public void addCompiledTrauma(CompiledTrauma compiledTrauma) {
        CompiledTrauma.addCompiledTrauma(compiledTraumas, compiledTrauma);
        addTraumas(compiledTrauma.genComponents());
    }
    ...
    public List<CompiledTrauma> getCompiledTraumas() {
